...
print ('''\033[1;34m
    ...
    :::::::::::::::::::::::::::::::::::::::::::::::::::
    :::::--------------------------------------------::
    ::---|....Tool By: Mohammad Hasan Rizvy Pranto..|::
    ::|YouTube Channel: Green Whale------------------::
    ::-----------------------------|:::::::::::::::::::
    :::::::::::::::::::::::::::::::::::::::::::::::::::
                          \033[37mMade with \033[91m<3\033[37m By Pranto\033[1;m''')

print ('''\n  I am not responsible for your shit and if you get some error while
 running Finder, there are good chances that target isn't responding.\n''')
print ('\033[1;31m--------------------------------------------------------------------------\033[1;m\n')

try:
    target = target.replace('https://', '') #Removes https://
except:
    print ('\033[1;31m[-]\033[1;m -u argument is not supplied. Enter python Finder -h for help')
    quit()
